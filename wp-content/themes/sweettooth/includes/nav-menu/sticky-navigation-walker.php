...
if (!class_exists('SweetToothElatedClassStickyNavigationWalker')) {
	class SweetToothElatedClassStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$item_output .= !empty($item->description) ? '<span class="eltdf-menu-description">'. $item->description .'</span>' : '';
