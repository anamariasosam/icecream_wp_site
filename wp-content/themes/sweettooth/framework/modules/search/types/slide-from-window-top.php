...
if ( ! function_exists('sweettooth_elated_get_search') ) {
	...
	add_action( 'sweettooth_elated_action_before_page_header', 'sweettooth_elated_get_search');
}
...
if ( ! function_exists('sweettooth_elated_load_search_template') ) {
    ...
    function sweettooth_elated_load_search_template() {
        ...
        if ( sweettooth_elated_options()->getOptionValue('search_icon_pack') !== '' ) {
            $search_icon .= sweettooth_elated_icon_collections()->getSearchIcon( sweettooth_elated_options()->getOptionValue('search_icon_pack'), true );
            $search_icon_close .= sweettooth_elated_icon_collections()->getSearchClose( sweettooth_elated_options()->getOptionValue('search_icon_pack'), true );
        }
        ...
        sweettooth_elated_get_module_template_part('templates/types/slide-from-window-top', 'search', '', $parameters);
    }
}