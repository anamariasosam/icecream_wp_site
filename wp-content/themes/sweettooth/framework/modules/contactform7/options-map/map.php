...
if ( ! function_exists('sweettooth_elated_contact_form_7_options_map') ) {

	function sweettooth_elated_contact_form_7_options_map() {

		sweettooth_elated_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'sweettooth'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = sweettooth_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'sweettooth')
		));

		//Text Typography

		$typography_text_group = sweettooth_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'sweettooth'),
			'description'	=> esc_html__('Setup typography for form elements text', 'sweettooth'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = sweettooth_elated_add_admin_row(array(
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'sweettooth'),
		));
		...
		$typography_text_row2 = sweettooth_elated_add_admin_row(array(
		...
		$typography_text_row3 = sweettooth_elated_add_admin_row(array(
		...
		$typography_label_group = sweettooth_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'sweettooth'),
			'description'	=> esc_html__('Setup typography for form elements label', 'sweettooth'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = sweettooth_elated_add_admin_row(array(
		...
		$typography_label_row2 = sweettooth_elated_add_admin_row(array(
		...
		$background_border_group = sweettooth_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'sweettooth'),
			'description'	=> esc_html__('Setup form elements background and border style', 'sweettooth'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = sweettooth_elated_add_admin_row(array(
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'sweettooth')
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'sweettooth')
		));

		$background_border_row2 = sweettooth_elated_add_admin_row(array(
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'sweettooth'),
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'sweettooth')
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'sweettooth')
		));

		$background_border_row3 = sweettooth_elated_add_admin_row(array(
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'sweettooth'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'sweettooth'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = sweettooth_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'sweettooth'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = sweettooth_elated_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'sweettooth'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'sweettooth'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'sweettooth'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'sweettooth'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = sweettooth_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'sweettooth'),
			'description'	=> esc_html__('Setup form elements margin', 'sweettooth'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = sweettooth_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'sweettooth'),
			'description'	=> esc_html__('Enter height for textarea form element', 'sweettooth'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = sweettooth_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'sweettooth'),
			'description'	=> esc_html__('Setup button text typography', 'sweettooth'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = sweettooth_elated_add_admin_row(array(
		...
		$button_typography_row2 = sweettooth_elated_add_admin_row(array(
		...
		$button_background_border_group = sweettooth_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'sweettooth'),
			'description'	=> esc_html__('Setup button background and border style', 'sweettooth'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = sweettooth_elated_add_admin_row(array(
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'sweettooth')
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'sweettooth')
		));

		$button_background_border_row2 = sweettooth_elated_add_admin_row(array(
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'sweettooth')
		));
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'sweettooth')
		));

		$button_background_border_row3 = sweettooth_elated_add_admin_row(array(
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'sweettooth'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		sweettooth_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'sweettooth'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = sweettooth_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'sweettooth')
		));
        ...
        $panel_contact_form_style_3 = sweettooth_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'sweettooth')
        ));
        ...
        $typography_label_row3 = sweettooth_elated_add_admin_row(array(
        ...
        $button_typography_row3 = sweettooth_elated_add_admin_row(array(
	...
	add_action( 'sweettooth_elated_action_options_map', 'sweettooth_elated_contact_form_7_options_map', 15);
}