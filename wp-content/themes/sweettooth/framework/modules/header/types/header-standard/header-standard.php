...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$menu_area_position                     = sweettooth_elated_get_meta_field_intersect( 'set_menu_area_position', $page_id );
		...
		$parameters = apply_filters( 'sweettooth_elated_filter_header_standard_parameters', $parameters );
