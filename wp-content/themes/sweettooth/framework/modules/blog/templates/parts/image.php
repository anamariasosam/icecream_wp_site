...
$blog_list_image_src = !empty($featured_image_meta) && sweettooth_elated_blog_item_has_link() ? $featured_image_meta : '';
?>
...
<?php if ( $has_featured ) { ?>
	<div class="eltdf-post-image">
        ...
        <?php if($blog_list_image_src !== '')  { ?>
            <img itemprop="image" class="eltdf-custom-post-image" src="<?php echo esc_url($blog_list_image_src); ?>" alt="<?php esc_html_e('Blog list featured image', 'sweettooth'); ?>" />
        <?php } else { ?>
