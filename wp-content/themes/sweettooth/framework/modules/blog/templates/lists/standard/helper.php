...
if( !function_exists('sweettooth_elated_get_blog_holder_classes') ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function sweettooth_elated_get_blog_holder_classes($classes) {
	...
	add_filter( 'sweettooth_elated_filter_blog_holder_classes', 'sweettooth_elated_get_blog_holder_classes' );
}
