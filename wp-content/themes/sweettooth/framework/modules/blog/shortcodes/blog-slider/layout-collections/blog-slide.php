                ...
                <div class="eltdf-item-text-holder-inner">
                    <?php if($post_info_date == 'yes' || $post_info_category == 'yes' || $post_info_author == 'yes' || $post_info_comments == 'yes'){ ?>
                        <div class="eltdf-item-info-section">
                            ...
                            <?php sweettooth_elated_get_module_template_part('templates/parts/post-info/category', 'blog', '', $params); ?>
                            <?php sweettooth_elated_get_module_template_part('templates/parts/post-info/comments', 'blog', '', $params); ?>
