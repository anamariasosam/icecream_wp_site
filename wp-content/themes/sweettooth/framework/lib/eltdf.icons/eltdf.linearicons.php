...
class SweetToothElatedClassLinearIcons implements iSweetToothElatedInterfaceIconCollection {
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="eltdf-icon-linear-icon lnr '.$icon.' '.$iconClass.'" '.$iconAttributesString.'></i>';
