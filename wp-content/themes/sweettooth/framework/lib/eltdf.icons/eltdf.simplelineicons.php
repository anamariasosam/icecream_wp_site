...
class SweetToothElatedClassSimpleLineIcons implements iSweetToothElatedInterfaceIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'sweettooth'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'sweettooth'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'sweettooth'),
            'icon-social-facebook'    => esc_html__('Facebook', 'sweettooth'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'sweettooth'),
            'icon-social-github'      => esc_html__('Github', 'sweettooth'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'sweettooth'),
            'icon-social-instagram'   => esc_html__('Instagram', 'sweettooth'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'sweettooth'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'sweettooth'),
            'icon-social-reddit'      => esc_html__('Reddit', 'sweettooth'),
            'icon-social-skype'       => esc_html__('Skype', 'sweettooth'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'sweettooth'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'sweettooth'),
            'icon-social-spotify'     => esc_html__('Spotify', 'sweettooth'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'sweettooth'),
            'icon-social-twitter'     => esc_html__('Twitter', 'sweettooth'),
            'icon-social-youtube'     => esc_html__('Youtube', 'sweettooth')
        );
    }
