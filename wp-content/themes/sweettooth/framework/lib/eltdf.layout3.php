...
/*
   Class: SweetToothElatedClassMultipleImages
   A class that initializes Elated Multiple Images
*/
class SweetToothElatedClassMultipleImages implements iSweetToothElatedInterfaceRender {
	private $name;
	private $label;
	private $description;
	...
	function __construct($name,$label="",$description="") {
		...
		$sweettooth_php_global_Framework->eltdMetaBoxes->addOption($this->name,"");
	}
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="eltdf-gallery-uploader">
								<a class="eltdf-gallery-upload-btn btn btn-sm btn-primary" href="javascript:void(0)"><?php esc_html_e('Upload', 'sweettooth'); ?></a>
								<a class="eltdf-gallery-clear-btn btn btn-sm btn-default pull-right" href="javascript:void(0)"><?php esc_html_e('Remove All', 'sweettooth'); ?></a>
							</div>
						</div>
					</div>
				</div>
...
/*
   Class: SweetToothElatedClassImagesVideos
   A class that initializes Elated Images Videos
*/
class SweetToothElatedClassImagesVideos implements iSweetToothElatedInterfaceRender {
	private $label;
	private $description;
	...
	public function render($factory) {
			...
			<div class="eltdf-page-form-section">
				...
				<div class="eltdf-section-content">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-2">
								<em class="eltdf-field-description"><?php esc_html_e('Order Number', 'sweettooth'); ?></em>
						...
						<div class="row next-row">
							<div class="col-lg-12">
								<em class="eltdf-field-description"><?php esc_html_e('Image', 'sweettooth'); ?></em>
								<div class="eltdf-media-uploader">
									...
									<a class="eltdf-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="<?php esc_html_e('Select Image', 'sweettooth'); ?>" data-frame-button-text="<?php esc_html_e('Select Image', 'sweettooth'); ?>"><?php esc_html_e('Upload', 'sweettooth'); ?></a>
									<a style="display: none;" href="javascript: void(0)" class="eltdf-media-remove-btn btn btn-default btn-sm"><?php esc_html_e('Remove', 'sweettooth'); ?></a>
								</div>
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-3">
								<em class="eltdf-field-description"><?php esc_html_e('Video Type', 'sweettooth'); ?></em>
								<select class="form-control eltdf-form-element eltdf-portfoliovideotype" name="portfoliovideotype_x" id="portfoliovideotype_x">
									<option value=""></option>
									<option value="youtube"><?php esc_html_e('YouTube', 'sweettooth'); ?></option>
									<option value="vimeo"><?php esc_html_e('Vimeo', 'sweettooth'); ?></option>
									<option value="self"><?php esc_html_e('Self Hosted', 'sweettooth'); ?></option>
								</select>
							</div>
							<div class="col-lg-3">
								<em class="eltdf-field-description"><?php esc_html_e('Video ID', 'sweettooth'); ?></em>
						...
						<div class="row next-row">
							<div class="col-lg-4">
								<em class="eltdf-field-description"><?php esc_html_e('Video mp4', 'sweettooth'); ?></em>
								<input type="text" class="form-control eltdf-input eltdf-form-element" id="portfoliovideomp4_x" name="portfoliovideomp4_x" />
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-12">
								<a class="eltdf_remove_image btn btn-sm btn-primary" href="/" onclick="javascript: return false;"><?php esc_html_e('Remove portfolio image/video', 'sweettooth'); ?></a>
							</div>
						</div>
					</div>
				</div>
		...
		if (count($portfolio_images)>1 && sweettooth_elated_core_plugin_installed()) {
								...
								<div class="col-lg-12">
									...
									<div class="eltdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfolioimg']) == false) { ?> style="display: none"<?php } ?> class="eltdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfolioimg']) == true) { echo esc_url(sweettooth_elated_get_attachment_thumb_url(stripslashes($portfolio_image['portfolioimg']))); } ?>" alt="" class="eltdf-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
							...
							<div class="row next-row">
								<div class="col-lg-3">
									...
									<select class="form-control eltdf-form-element eltdf-portfoliovideotype" name="portfoliovideotype[]" id="portfoliovideotype_<?php echo esc_attr($no); ?>">
										<option value=""></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "youtube") { echo "selected='selected'"; } ?>  value="youtube"><?php esc_html_e('YouTube', 'sweettooth'); ?></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "vimeo") { echo "selected='selected'"; } ?>  value="vimeo"><?php esc_html_e('Vimeo', 'sweettooth'); ?></option>
										<option <?php if ($portfolio_image['portfoliovideotype'] == "self") { echo "selected='selected'"; } ?>  value="self"><?php esc_html_e('Self Hosted', 'sweettooth'); ?></option>
									</select>
								</div>
								<div class="col-lg-3">
									<em class="eltdf-field-description"><?php esc_html_e('Video ID', 'sweettooth'); ?></em>
								...
								<div class="col-lg-12">
									...
									<div class="eltdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == false) { ?> style="display: none"<?php } ?> class="eltdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == true) { echo esc_url(sweettooth_elated_get_attachment_thumb_url(stripslashes($portfolio_image['portfoliovideoimage']))); } ?>" alt="" class="eltdf-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
		...
		?>
		<br />
		<a class="eltdf_add_image btn btn-sm btn-primary" onclick="javascript: return false;" href="/"><?php esc_html_e('Add portfolio image/video', 'sweettooth'); ?></a>
	<?php
	}
}
...
/*
   ...
   A class that initializes Elated Images Videos
*/
class SweetToothElatedClassImagesVideosFramework implements iSweetToothElatedInterfaceRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		<div class="eltdf-hidden-portfolio-images"  style="display: none">
			<div class="eltdf-portfolio-toggle-holder">
				<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
					<span class="number">1</span><span class="eltdf-toggle-inner"><?php esc_html_e('Image - ', 'sweettooth'); ?><em><?php esc_html_e('Order Number', 'sweettooth'); ?></em></span>
				</div>
		...
		<div class="eltdf-hidden-portfolio-videos"  style="display: none">
			<div class="eltdf-portfolio-toggle-holder">
				<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
					<span class="number">2</span><span class="eltdf-toggle-inner"><?php esc_html_e('Video - ', 'sweettooth'); ?><em><?php esc_html_e('Order Number', 'sweettooth'); ?></em></span>
				</div>
				<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
					...
					<div class="eltdf-section-content">
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-2">
									<div class="eltdf-media-uploader">
										<em class="eltdf-field-description"><?php esc_html_e('Cover Video Image', 'sweettooth'); ?></em>
										<div style="display: none" class="eltdf-media-image-holder">
											<img src="" alt="" class="eltdf-media-image img-thumbnail">
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
								...
								<div class="col-lg-10">
									...
									<div class="row next-row">
										...
										<div class="col-lg-2 eltdf-video-id-holder">
											<em class="eltdf-field-description" id="videoId"><?php esc_html_e('Video ID', 'sweettooth'); ?></em>
											<input type="text" class="form-control eltdf-input eltdf-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x">
										</div>
									</div>
		...
		while (isset($portfolio_images[$no-1])) {
			...
			if ($portfolio_img_type == "image") {
				...
				<div class="eltdf-portfolio-images eltdf-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="eltdf-portfolio-toggle-holder">
						<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="eltdf-toggle-inner"><?php esc_html_e('Image - ', 'sweettooth'); ?><em><?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?></em></span>
						</div>
						<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
			...
			<?php
				...
				<div class="eltdf-portfolio-videos eltdf-portfolio-media" rel="<?php echo esc_attr($no); ?>">
					<div class="eltdf-portfolio-toggle-holder">
						<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
							<span class="number"><?php echo esc_html($no); ?></span><span class="eltdf-toggle-inner"><?php esc_html_e('Video - ', 'sweettooth'); ?><em><?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?></em></span>
						</div>
						<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
		...
		<div class="eltdf-portfolio-add">
			<a class="eltdf-add-image btn btn-sm btn-primary" href="#"><i class="fa fa-camera"></i><?php esc_html_e('Add Image', 'sweettooth'); ?></a>
			<a class="eltdf-add-video btn btn-sm btn-primary" href="#"><i class="fa fa-video-camera"></i><?php esc_html_e('Add Video', 'sweettooth'); ?></a>
			<a class="eltdf-toggle-all-media btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'sweettooth'); ?></a>
		</div>
	<?php
	}
}

class SweetToothElatedClassTwitterFramework implements  iSweetToothElatedInterfaceRender {
    public function render($factory) {
        ...
        if(!empty($_GET['oauth_token']) && !empty($_GET['oauth_verifier'])) {
            ...
            if($responseObj->status) {
                $message = esc_html__('You have successfully connected with your Twitter account. If you have any issues fetching data from Twitter try reconnecting.', 'sweettooth');
            } else {
                $message = $responseObj->message;
            }
        }

        $buttonText = $twitterApi->hasUserConnected() ? esc_html__('Re-connect with Twitter', 'sweettooth') : esc_html__('Connect with Twitter', 'sweettooth');
    ?>
        <?php if($message !== '') { ?>
        ...
        <div class="eltdf-page-form-section" id="eltdf_enable_social_share">
            <div class="eltdf-field-desc">
                <h4><?php esc_html_e('Connect with Twitter', 'sweettooth'); ?></h4>
                <p><?php esc_html_e('Connecting with Twitter will enable you to show your latest tweets on your site', 'sweettooth'); ?></p>
            </div>
            <div class="eltdf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
class SweetToothElatedClassInstagramFramework implements  iSweetToothElatedInterfaceRender {
    public function render($factory) {
		...
		if(!get_option('eltdf_instagram_code')) {
			...
			if(!empty($_GET['code'])) {
				...
				$message = esc_html__('You have successfully connected with your Instagram account. If you have any issues fetching data from Instagram try reconnecting.', 'sweettooth');
		...
		$buttonText = $instagram_api->hasUserConnected() ? esc_html__('Re-connect with Instagram', 'sweettooth') : esc_html__('Connect with Instagram', 'sweettooth');
    ...
    ?>
        ...
        <div class="eltdf-page-form-section" id="eltdf_enable_social_share">
            <div class="eltdf-field-desc">
                <h4><?php esc_html_e('Connect with Instagram', 'sweettooth'); ?></h4>
                <p><?php esc_html_e('Connecting with Instagram will enable you to show your latest photos on your site', 'sweettooth'); ?></p>
            </div>
            <div class="eltdf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
/*
   ...
   A class that initializes Elated Images Videos
*/
class SweetToothElatedClassOptionsFramework implements iSweetToothElatedInterfaceRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		<div class="eltdf-portfolio-additional-item-holder" style="display: none">
			<div class="eltdf-portfolio-toggle-holder">
				<div class="eltdf-portfolio-toggle eltdf-toggle-desc">
					<span class="number">1</span><span class="eltdf-toggle-inner">Additional Sidebar Item <em><?php esc_html_e('(Order Number, Item Title)', 'sweettooth'); ?></em></span>
				</div>
				<div class="eltdf-portfolio-toggle eltdf-portfolio-control">
					...
					<div class="eltdf-section-content">
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-lg-10">
									<em class="eltdf-field-description"><?php esc_html_e('Item Title', 'sweettooth'); ?></em>
									<input type="text" class="form-control eltdf-input eltdf-form-element" id="optionLabel_x" name="optionLabel_x">
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="eltdf-field-description"><?php esc_html_e('Item Text', 'sweettooth'); ?></em>
									<textarea class="form-control eltdf-input eltdf-form-element" id="optionValue_x" name="optionValue_x"></textarea>
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="eltdf-field-description"><?php esc_html_e('Enter Full URL for Item Text Link', 'sweettooth'); ?></em>
		...
		if (count($portfolios)>1 && sweettooth_elated_core_plugin_installed()) {
		...
		<div class="eltdf-portfolio-add">
			<a class="eltdf-add-item btn btn-sm btn-primary" href="#"><?php esc_html_e('Add New Item', 'sweettooth'); ?></a>
			<a class="eltdf-toggle-all-item btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'sweettooth'); ?></a>
		</div>
	<?php
	}
}