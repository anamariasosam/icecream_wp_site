				...
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[eltdf_dropcaps type="' + e.data.type + '" color="' + e.data.color + '" background_color="' + e.data.background_color + '"]'+ e.data.letter +'[/eltdf_dropcaps]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[eltdf_highlight background_color="' + e.data.background_color + '" color="' + e.data.color + '"]'+ e.data.text +'[/eltdf_highlight]');
							}
						});
					}
				},
						...
						ed.windowManager.open( {
							...
							body: [
								...
								},
								{
									...
									label: 'Size',
									'values': [
										{text: 'Tiny', value: 'eltdf-icon-tiny'},
										{text: 'Small', value: 'eltdf-icon-small'},
										{text: 'Medium', value: 'eltdf-icon-medium'},
										{text: 'Large', value: 'eltdf-icon-large'},
										{text: 'Very Large', value: 'eltdf-icon-huge'}
									]
								},
								{
									type: 'textbox',
				...
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[eltdf_inner_row_holder space_between_columns="' + e.data.space_between_columns + '" text_alignment="' + e.data.text_alignment + '"][eltdf_inner_row_column column_size="6"]Left column text content[/eltdf_inner_row_column][eltdf_inner_row_column column_size="6"]Right column text content[/eltdf_inner_row_column][/eltdf_inner_row_holder]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent('[eltdf_separator class_name="' + e.data.class_name + '" type="' + e.data.type + '" position="' + e.data.position + '" color="' + e.data.color + '" border_style="' + e.data.border_style + '" width="' + e.data.width + '" thickness="' + e.data.thickness + '" top_margin="' + e.data.top_margin + '" bottom_margin="' + e.data.bottom_margin + '"]');
							}
						});
					}
				}
