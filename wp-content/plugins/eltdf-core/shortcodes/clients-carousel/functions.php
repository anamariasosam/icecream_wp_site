...
if( !function_exists('eltdf_core_set_clients_carousel_custom_style_for_vc_shortcodes') ) {
	/**
	 * Function that set custom css style for clients carousel shortcode
	 */
	function eltdf_core_set_clients_carousel_custom_style_for_vc_shortcodes($style) {
	...
	add_filter('eltdf_core_filter_add_vc_shortcodes_custom_style', 'eltdf_core_set_clients_carousel_custom_style_for_vc_shortcodes');
}

if( !function_exists('eltdf_core_set_clients_carousel_icon_class_name_for_vc_shortcodes') ) {
	/**
	 ...
	 */
	function eltdf_core_set_clients_carousel_icon_class_name_for_vc_shortcodes($shortcodes_icon_class_array) {
	...
	add_filter('eltdf_core_filter_add_vc_shortcodes_custom_icon_class', 'eltdf_core_set_clients_carousel_icon_class_name_for_vc_shortcodes');
}