...
<div class="eltdf-image-gallery <?php echo esc_attr($holder_classes); ?>">
	<div class="eltdf-ig-inner <?php echo esc_attr($inner_classes); ?>">
		...
		<?php foreach ($images as $image) { ?>
			...
			?>
			<div class="eltdf-ig-image <?php echo esc_attr($image_classes); ?>">
				<div class="eltdf-ig-image-inner">
					...
					<?php } ?>
						<?php if(is_array($image_size) && count($image_size)) :
							echo sweettooth_elated_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]);
						else:
