...
class ImageWithText implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Center', 'eltdf-core' )       => 'eltdf-content-center',
								esc_html__( 'Left', 'eltdf-core' )     => 'eltdf-content-left'
							),
							'save_always' => true
						),
						array(
	...
	public function render( $atts, $content = null ) {
		$args   = array(
			...
			'content_alignment'  => 'eltdf-content-center',
			'title'              => '',
			'title_tag'          => 'p',
			'title_color'        => '',
			'title_top_margin'   => '',
	...
	private function getHolderClasses( $params, $args ) {
		...
		$holderClasses[] = !empty($params['content_alignment']) ? $params['content_alignment'] : '';
