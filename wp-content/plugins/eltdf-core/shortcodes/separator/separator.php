...
class Separator implements Lib\ShortcodeInterface {
	...
	private function getSeparatorStyles($params) {
		...
		if ($params['width'] !== '') {
			if(sweettooth_elated_string_ends_with($params['width'], '%') || sweettooth_elated_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(sweettooth_elated_string_ends_with($params['top_margin'], '%') || sweettooth_elated_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(sweettooth_elated_string_ends_with($params['bottom_margin'], '%') || sweettooth_elated_string_ends_with($params['bottom_margin'], 'px')) {
