    ...
    */
	...
	public function render($atts, $content = null) {
		...
		if(!empty($image_top_offset)) {
			$item_image_style = 'margin-top: '.sweettooth_elated_filter_px($image_top_offset).'px';
		}

        $html .= '<div class="eltdf-item-showcase-holder clearfix">';
			$html .= do_shortcode($content);
			$html .= '<div class="eltdf-is-image" '.sweettooth_elated_get_inline_style($item_image_style).'>';
                if (!empty($item_image)) {
