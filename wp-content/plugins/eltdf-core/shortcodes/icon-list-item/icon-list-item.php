...
class IconListItem implements Lib\ShortcodeInterface {
	...
	public function render($atts, $content = null) {
        ...
        $args = array_merge($args, sweettooth_elated_icon_collections()->getShortcodeParams());
	...
	private function getHolderStyles($params){
		...
		if(!empty($params['item_margin'])) {
			$styles[] = 'margin-bottom: '.sweettooth_elated_filter_px($params['item_margin']).'px';
		}
	...
	private function getIconStyles($params){
		...
		if (!empty($params['icon_size'])) {
			$styles[] = 'font-size: '.sweettooth_elated_filter_px($params['icon_size']).'px';
		}
	...
	private function getTitleStyles($params){
		...
		if (!empty($params['title_size'])) {
			$styles[] = 'font-size: '.sweettooth_elated_filter_px( $params['title_size']).'px';
		}
		
		if(!empty($params['title_padding'])) {
			$styles[] = 'padding-left: '.sweettooth_elated_filter_px($params['title_padding']).'px';
		}
