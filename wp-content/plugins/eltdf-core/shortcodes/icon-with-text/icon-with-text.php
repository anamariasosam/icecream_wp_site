...
class IconWithText implements Lib\ShortcodeInterface {
		    ...
		    vc_map(
		    	array(
				    ...
				    'params'                    => array_merge(
					    ...
					    sweettooth_elated_icon_collections()->getVCParamsArray(),
					    array(
						    array(
							    'type'       => 'attach_image',
    ...
    private function getIconParameters($params) {
        ...
        if(empty($params['custom_icon'])) {
            ...
            if(!empty($params['custom_icon_size'])) {
                $params_array['custom_size'] = sweettooth_elated_filter_px($params['custom_icon_size']).'px';
            }
	        ...
	        if(!empty($params['shape_size'])) {
		        $params_array['shape_size'] = sweettooth_elated_filter_px($params['shape_size']).'px';
	        }
            ...
            if($params['icon_border_width'] !== '') {
                $params_array['border_width'] = sweettooth_elated_filter_px($params['icon_border_width']).'px';
            }
	...
	private function getContentStyles($params) {
		...
		if($params['text_padding'] !== '' && $params['type'] === 'icon-left') {
			$styles[] = 'padding-left: '.sweettooth_elated_filter_px($params['text_padding']).'px';
		}
		
		if($params['text_padding'] !== '' && $params['type'] === 'icon-top') {
			$styles[] = 'padding-top: '.sweettooth_elated_filter_px($params['text_padding']).'px';
		}
    ...
    private function getTitleStyles($params) {
	    ...
	    if(!empty($params['title_top_margin'])) {
		    $styles[] = 'margin-top: '.sweettooth_elated_filter_px($params['title_top_margin']).'px';
	    }
    ...
    private function getTextStyles($params) {
	    ...
	    if(!empty($params['text_top_margin'])) {
		    $styles[] = 'margin-top: '.sweettooth_elated_filter_px($params['text_top_margin']).'px';
	    }
