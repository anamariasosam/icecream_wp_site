...
if(!function_exists('sweettooth_elated_get_button_html')) {
    /**
     ...
     * @return mixed|string
     */
    function sweettooth_elated_get_button_html($params) {
        $button_html = sweettooth_elated_execute_shortcode('eltdf_button', $params);
