...
if(!function_exists('sweettooth_elated_add_user_custom_fields')) {
	/**
	 * Function creates custom social fields for users
	 *
	 * return $user_contact
	 */
	function sweettooth_elated_add_user_custom_fields($user_contact) {
		/**
	...
	add_filter('user_contactmethods', 'sweettooth_elated_add_user_custom_fields');
}
