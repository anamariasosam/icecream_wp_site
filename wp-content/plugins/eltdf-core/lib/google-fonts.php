<?php
if ( ! function_exists( 'sweettooth_elated_init_google_fonts_array' ) ) {
    function sweettooth_elated_init_google_fonts_array() {

        global $sweettooth_php_global_fonts_array;
        $sweettooth_php_global_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'sweettooth_elated_init_google_fonts_array');
}