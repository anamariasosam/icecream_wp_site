...
class TestimonialsRegister implements Lib\PostTypeInterface {
    ...
    private function registerPostType() {
        ...
        if(eltdf_core_theme_installed()) {
            $menuPosition = $sweettooth_php_global_Framework->getSkin()->getMenuItemPosition('testimonial');
            $menuIcon = $sweettooth_php_global_Framework->getSkin()->getMenuIcon('testimonial');
        }
