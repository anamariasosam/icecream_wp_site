...
if(!function_exists('eltdf_core_masonry_gallery_meta_box_functions')) {
	...
	add_filter('sweettooth_elated_filter_meta_box_post_types_save', 'eltdf_core_masonry_gallery_meta_box_functions');
	add_filter('sweettooth_elated_filter_meta_box_post_types_remove', 'eltdf_core_masonry_gallery_meta_box_functions');
}
