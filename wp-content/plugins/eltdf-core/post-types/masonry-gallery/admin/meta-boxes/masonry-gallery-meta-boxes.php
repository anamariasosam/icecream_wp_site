...
if(!function_exists('eltdf_core_map_masonry_gallery_meta')) {
    function eltdf_core_map_masonry_gallery_meta() {
        $masonry_gallery_meta_box = sweettooth_elated_add_meta_box(
            array(
	    ...
	    sweettooth_elated_add_meta_box_field(
		    array(
			    'name' => 'eltdf_masonry_gallery_disable_hover',
			    'type' => 'yesno',
			    'default_value' => 'no',
			    'label' => esc_html__('Disable hover on masonry item', 'eltdf-core'),
			    'parent' => $masonry_gallery_meta_box
		    )
	    );
        ...
        $masonry_gallery_item_button_type_container = sweettooth_elated_add_admin_container_no_style(array(
        ...
        $masonry_gallery_item_simple_type_container = sweettooth_elated_add_admin_container_no_style(array(
    ...
    add_action('sweettooth_elated_action_meta_boxes_map', 'eltdf_core_map_masonry_gallery_meta', 45);
}