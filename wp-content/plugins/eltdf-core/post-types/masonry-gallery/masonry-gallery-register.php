...
class MasonryGalleryRegister implements Lib\PostTypeInterface  {
	...
	private function registerPostType() {
	   ...
	   if(eltdf_core_theme_installed()) {
		   $menuPosition = $sweettooth_php_global_Framework->getSkin()->getMenuItemPosition('masonry-gallery');
		   $menuIcon = $sweettooth_php_global_Framework->getSkin()->getMenuIcon('masonry-gallery');
	   }
