...
if(!function_exists('eltdf_core_include_custom_post_types_meta_boxes')) {
	...
	add_action('sweettooth_elated_action_before_meta_boxes_map', 'eltdf_core_include_custom_post_types_meta_boxes');
}
...
if(!function_exists('eltdf_core_include_custom_post_types_global_options')) {
	...
	add_action('sweettooth_elated_action_before_options_map', 'eltdf_core_include_custom_post_types_global_options', 1);
}