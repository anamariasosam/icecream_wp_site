...
if ( ! function_exists('sweettooth_elated_portfolio_options_map') ) {
	function sweettooth_elated_portfolio_options_map() {
		...
		$panel_archive = sweettooth_elated_add_admin_panel(array(
		...
		$panel = sweettooth_elated_add_admin_panel(array(
		...
		$portfolio_gallery_container = sweettooth_elated_add_admin_container(array(
			'parent'          => $panel,
		...
		$portfolio_masonry_container = sweettooth_elated_add_admin_container(array(
			'parent'          => $panel,
		...
		sweettooth_elated_add_admin_field(array(
			...
			$container_navigate_category = sweettooth_elated_add_admin_container(array(
	...
	add_action( 'sweettooth_elated_action_options_map', 'sweettooth_elated_portfolio_options_map', 12);
}