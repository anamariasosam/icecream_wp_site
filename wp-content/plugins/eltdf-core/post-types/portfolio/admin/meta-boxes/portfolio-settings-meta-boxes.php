...
if(!function_exists('eltdf_core_map_portfolio_settings_meta')) {
    function eltdf_core_map_portfolio_settings_meta() {
        $meta_box = sweettooth_elated_add_meta_box(array(
	    ...
	    $gallery_type_meta_container = sweettooth_elated_add_admin_container(
		    array(
			    'parent' => $meta_box,
	    ...
	    $masonry_type_meta_container = sweettooth_elated_add_admin_container(
		    array(
			    'parent' => $meta_box,
    ...
    add_action('sweettooth_elated_action_meta_boxes_map', 'eltdf_core_map_portfolio_settings_meta', 41);
}