<?php
$masonry_classes = '';
$number_of_columns = sweettooth_elated_get_meta_field_intersect('portfolio_single_masonry_columns_number');
if(!empty($number_of_columns)) {
	$masonry_classes .= ' eltdf-ps-'.$number_of_columns.'-columns';
}
$space_between_items = sweettooth_elated_get_meta_field_intersect('portfolio_single_masonry_space_between_items');
