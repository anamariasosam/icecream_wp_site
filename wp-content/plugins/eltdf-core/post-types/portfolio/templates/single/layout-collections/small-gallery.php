<?php
$gallery_classes = '';
$number_of_columns = sweettooth_elated_get_meta_field_intersect('portfolio_single_gallery_columns_number');
if(!empty($number_of_columns)) {
	$gallery_classes .= ' eltdf-ps-'.$number_of_columns.'-columns';
}
$space_between_items = sweettooth_elated_get_meta_field_intersect('portfolio_single_gallery_space_between_items');
if(!empty($space_between_items)) {
	$gallery_classes .= ' eltdf-ps-'.$space_between_items.'-space';
}
?>
<div class="eltdf-grid-row">
	...
	<div class="eltdf-grid-col-4">
		<div class="eltdf-ps-info-holder">
			...
			eltdf_core_get_cpt_single_module_template_part('templates/single/parts/content', 'portfolio', $item_layout);

			// get portfolio author section
			eltdf_core_get_cpt_single_module_template_part('templates/single/parts/author', 'portfolio', $item_layout);
			?>
			<div class="eltdf-ps-meta">
				<?php
