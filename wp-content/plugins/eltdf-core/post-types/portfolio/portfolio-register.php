...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $sweettooth_php_global_Framework, $sweettooth_php_global_options;
        ...
        if(eltdf_core_theme_installed()) {
            $menuPosition = $sweettooth_php_global_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $sweettooth_php_global_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($sweettooth_php_global_options['portfolio_single_slug'])) {
                if($sweettooth_php_global_options['portfolio_single_slug'] != ""){
                    $slug = $sweettooth_php_global_options['portfolio_single_slug'];
                }
            }
        }
