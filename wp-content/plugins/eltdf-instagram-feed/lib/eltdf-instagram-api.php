...
include 'eltdf-instagram-helper.php';

/**
 * Class ElatedfInstagramApi
 */
class ElatedfInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var ElatedfInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var ElatedfInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'eltdf_instagram_code';
    const USER_ID_OPTION_NAME = 'eltdf_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'eltdf_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'eltdf_instagram_code_redirect_uri';

    /**
     * Private constructor because of singletone pattern. It sets all necessary properties
     */
    private function __construct() {
	    $this->clientID = '2ead2d4b1018461aa64f410e07d3cd0b';
	    $this->clientSecret = '9d9da41806804ec786caaa77f82bd36c';
	    $this->redirectUri = 'http://demo.elated-themes.com/instagram-app/instagram-redirect.php';
        ...
        $this->helper = new ElatedfInstagramHelper();
    }
     ...
     * @return string
     *
     * @see ElatedfInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see ElatedfInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see ElatedfInstagramApi::getAccessToken()
     */
